...
base_input_folder = 'datasets/dataset_2/raw/'  # Base folder containing subfolders with images
base_output_folder = 'datasets/dataset_2/processed/'  # Base folder to store processed images
